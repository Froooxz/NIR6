...
class HeatingEnvDQN(gym.Env):
    def __init__(self):
        super(HeatingEnvDQN, self).__init__()
        ...
        self.action_space = gym.spaces.Discrete(3)  # Определение пространства действий агента
    ...
    def step(self, action):
        ...
        self.U_reg += self._action_to_direction[action]  # Обновляем коэффициенты на основе действия агента
